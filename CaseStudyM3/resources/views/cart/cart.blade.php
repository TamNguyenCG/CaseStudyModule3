            ...
            <div class="row hide-on-med-and-up" v-cloak>
                <div class="col s12 m6">
                    <div class="card">
                        ...
                        <a on:click="scrollToBottom(); $v.name.$touch(); $v.address.$touch(); $v.email.$touch(); $v.phone.$touch();" class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">arrow_downward
                            </i></a>
                    </div>

    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="{{route('products.shop')}}">All</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="{{route('products.men')}}">Men's</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none" href=" {{route('products.women')}}">Women's</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-1"><a class="btn btn-primary" href="{{route('products.create')}}">Add New Product</a></div>
                ...
                <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0" >
                                <div class="card rounded-0">
                                    <img class="card-img rounded-0 img-fluid" style="height: 250px" src="{{ asset('storage/image/'.$product->image) }}">
                                    <div
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination" style="float: right">
                            {{$menproducts->appends(request()->query())}}
                        </ul>
                    </nav>
                </div>
            </div>

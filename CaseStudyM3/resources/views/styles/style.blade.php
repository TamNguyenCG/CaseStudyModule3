    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-md-7">
                <ul class="list-inline shop-top-menu pb-3 pt-1">
                    ...
                    <li class="list-inline-item">
                        <a class="h3 text-dark text-decoration-none mr-3"
                           href="{{route('products.filterByStyle')}}">Men's</a>
                    </li>
                    <li class="list-inline-item">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <!-- Modal -->
                    <div class="modal fade" id="styleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                         aria-hidden="true">
                        <form action="{{route('products.filterByStyle')}}" method="get">
                            @csrf
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" id="category-choose" class="btn btn-primary">Choose
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        <table>
                                            <tr>
                                                <th>Style for:</th>
                                                <td>
                                                    <select name="style_id" id="category-select" class="form-select">
